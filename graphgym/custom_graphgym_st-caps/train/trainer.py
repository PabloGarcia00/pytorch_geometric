...
from custom_graphgym.network.model import STSGCCaps
from custom_graphgym.optimizer.optimizer import get_optimizer
from custom_graphgym.metric.metrics import calculate_metrics
